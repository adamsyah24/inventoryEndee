    ...
    class BookingPress Extends BookingPress_Core
    {
        ...
        function bookingpress_admin_footer_func()
        {
            ...
            if (strpos($requested_module, 'bookingpress_') !== false || $requested_module == 'bookingpress' ) {
                ...
                <?php
                if (( isset($_REQUEST['page']) && $_REQUEST['page'] == 'bookingpress' ) || $requested_module == 'appointments' || $requested_module == 'calendar' || $requested_module == 'services' || $requested_module == 'staff_members' || $requested_module == 'settings' || $requested_module == 'timesheet' || $requested_module == 'payments' || $requested_module == 'customize' || $requested_module == 'customers') {
                    ?>
                    ...
                    <?php do_action('bookingpress_' . $requested_module . '_dynamic_computed_methods'); ?>
                        ...
                        mounted() {
                            ...
                            <?php
                                ...
                                if( ( isset($_REQUEST['page']) && $_REQUEST['page'] != 'bookingpress_lite_wizard') && ( 'false' == $bpa_is_dispayed_before_end || false == $bpa_is_dispayed_before_end ) && ('1692340200' <= $bpa_current_date_for_bf_popup ) ){
                            ...
                            <?php
                                ...
                                if( '1692340200' <= $bpa_current_date_for_bf_popup ) {
                        ...
                        methods: {
                            ...
                            bookingpress_redirect_sale_premium_page(){
                                window.open('https://www.bookingpressplugin.com/pricing/?utm_source=liteversion&utm_medium=plugin&utm_campaign=birthdaysale_2023&utm_id=bookingpress_2', '_blank');
                            },
        ...
        function bookingpress_retrieve_all_services( $service = '', $selected_service = '', $bookingpress_category = 0 ){
            ...
            $bookingpress_duration_suffix_labels = array(
                'm' => !empty( $min_text ) ? $min_text : esc_html__('m', 'bookingpress-appointment-booking'),
                'h' => !empty( $hour_text ) ? $hour_text : esc_html__('h', 'bookingpress-appointment-booking'),
            );
            ...
            foreach( $get_category_ids as $category_id => $category_ids_data ){
                if( 0 === $category_id ){
                    $bpa_uncategorized_data[0] = array(
                        'category_id' => 0,
                        'category_key' => 'all',
                        'category_name' => $bookingpress_all_category_title,
        ...
        function bookingpress_install_default_notification_data()
        {
            ...
            'Appointment Approved' => __('Dear %customer_first_name% %customer_last_name%,<br>You have successfully scheduled appointment.<br>Thank you for choosing us,<br>%company_name%','bookingpress-appointment-booking'),
            'Appointment Pending'  => __('Dear %customer_first_name% %customer_last_name%,<br>The %service_name% appointment is scheduled and it\'s waiting for a confirmation.<br>Thank you for choosing us,<br>%company_name%','bookingpress-appointment-booking'),
            'Appointment Rejected' => __('Dear %customer_first_name% %customer_last_name%,<br>The %service_name% appointment, has been rejected.<br>Thank you for choosing us,<br>%company_name%','bookingpress-appointment-booking'),
            'Appointment Canceled' => __('Dear %customer_first_name% %customer_last_name%,<br>The %service_name% appointment, has been canceled.<br>Thank you for choosing us,<br>%company_name%','bookingpress-appointment-booking'),
            'Share Appointment URL' => __('Hi<br/>Please book your appointment with following URL: <br/>%share_appointment_url%<br/>Thanks,<br/>%company_name%','bookingpress-appointment-booking'),
            );
            ...
            'Appointment Approved' => __('Hi administrator,<br>You have one confirmed %service_name% appointment. The appointment is added to your schedule.<br>Thank you,<br>%company_name%','bookingpress-appointment-booking'),
            'Appointment Pending'  => __('Hi administrator,<br>You have new appointment in %service_name%. The appointment is waiting for a confirmation.<br>Thank you,<br>%company_name%','bookingpress-appointment-booking'),
            'Appointment Rejected' => __('Hi administrator,<br>Your %service_name% appointment, has been rejected.<br>Thank you,<br>%company_name%','bookingpress-appointment-booking'),
            'Appointment Canceled' => __('Hi administrator,<br>Your %service_name% appointment, has been canceled.<br>Thank you,<br>%company_name%','bookingpress-appointment-booking'),
            'Share Appointment URL' => __('Hi administrator,<br>Following appointment URL is shared with customer. <br/>%share_appointment_url%<br/>Thank you,<br/>%company_name%','bookingpress-appointment-booking'),
            );
