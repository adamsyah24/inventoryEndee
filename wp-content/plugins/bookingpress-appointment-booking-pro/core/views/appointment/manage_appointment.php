				...
				<el-container class="bpa-table-container">
					...
					<div class="bpa-tc__wrapper" v-if="current_screen_size == 'desktop'">
						<el-table ref="multipleTable" class="bpa-manage-appointment-items" :data="items" @selection-change="handleSelectionChange" fit="false" @row-click="bookingpress_full_row_clickable" @expand-change="bookingpress_row_expand">
							...
							<el-table-column prop="appointment_payment" min-width="100" label="<?php esc_html_e( 'Payment', 'bookingpress-appointment-booking' ); ?>" sortable sort-by=
							"payment_numberic_amount">
								<template slot-scope="scope">
								...
								<el-row>
									<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
										<el-form-item>
											...
											<el-input-number v-model="share_url_form.selected_guests" class="bpa-form-control bpa-form-control--number" :min="1" :max="share_url_form.selected_guests_max_capacity" step-strictly @change="bookingpress_generate_share_url"></el-input-number>
										</el-form-item>
									</el-col>
								</el-row>
							</div>
