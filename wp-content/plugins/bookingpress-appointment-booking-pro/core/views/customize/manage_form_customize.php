                            ...
                            <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
                                <div class="bpa-customize-step-side-panel">
                                    ...
                                    <div class="bpa-cs-sp-sub-module bpa-sm--swtich">
                                        ...
                                        <div class="bpa-sm--item --bpa-is-flexbox">
                                            <label class="bpa-form-label"><?php echo stripslashes_deep( esc_html__('Select "All" as default category', 'bookingpress-appointment-booking') ); ?></label>
                            ...
                            <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
                                <div class="bpa-customize-step-side-panel">
                                    ...
                                    <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls">                                        
                                        ...
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Card name placholder', 'bookingpress-appointment-booking'); ?></label>
