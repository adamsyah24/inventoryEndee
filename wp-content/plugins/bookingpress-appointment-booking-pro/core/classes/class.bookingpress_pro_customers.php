...
if ( ! class_exists( 'bookingpress_pro_customers' ) ) {
	class bookingpress_pro_customers Extends BookingPress_Core {
		...
		function __construct() {
			...
			add_filter( 'bookingpress_user_password_change_filter', array( $this, 'bookingpress_user_password_change_filter_func'));
		}


		function bookingpress_user_password_change_filter_func( $bookingpress_user_pass ){
