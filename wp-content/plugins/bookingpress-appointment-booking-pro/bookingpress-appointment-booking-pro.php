...
update_option( 'bkp_license_key', '**************' );
update_option( 'bkp_license_package', 'professional');
update_option( 'bkp_license_status', 'valid' );
update_option( 'bkp_license_data_activate_response', json_encode(['license_limit' => '999', 'expires' => 'January 1,2040', 'customer_name' => 'babia.to', 'customer_email' => 'babia@to'] ) );
